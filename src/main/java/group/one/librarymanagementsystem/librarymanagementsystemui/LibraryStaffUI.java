...
public class LibraryStaffUI {
    ...
    @FXML
    private Button librarystaff_returnBookbtn;
    @FXML
    ...
    void getUserList() {
        userList = db.queryView("SELECT * FROM users WHERE role = '" + patronRoleName+ "'");
    ...
    public void refreshList() {
        ...
        String sumQuery = "SELECT SUM(fine) AS totalFine FROM users WHERE role ='" + patronRoleName+"'";
